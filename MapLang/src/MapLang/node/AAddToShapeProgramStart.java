...
public final class AAddToShapeProgramStart extends PProgramStart
{
    private TId _id_;
    private PTypeList _typeList_;

    public AAddToShapeProgramStart()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddToShapeProgramStart(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAddToShapeProgramStart(this);
    }
