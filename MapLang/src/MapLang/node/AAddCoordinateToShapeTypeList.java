...
public final class AAddCoordinateToShapeTypeList extends PTypeList
{
    private PAstMultiCoordinate _astMultiCoordinate_;

    public AAddCoordinateToShapeTypeList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddCoordinateToShapeTypeList(
    ...
    {
        ((Analysis) sw).caseAAddCoordinateToShapeTypeList(this);
    }
