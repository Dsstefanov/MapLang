...
public final class ARelationExplicitAstRelation extends PAstRelation
{
    private PAstPreciseDir _astPreciseDir_;
    private PAstRelationExplicit _astRelationExplicit_;

    public ARelationExplicitAstRelation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARelationExplicitAstRelation(
    ...
    {
        ((Analysis) sw).caseARelationExplicitAstRelation(this);
    }
