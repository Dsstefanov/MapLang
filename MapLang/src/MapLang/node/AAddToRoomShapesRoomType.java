...
public final class AAddToRoomShapesRoomType extends PRoomType
{
    private PAstMultiId _astMultiId_;

    public AAddToRoomShapesRoomType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddToRoomShapesRoomType(
    ...
    {
        ((Analysis) sw).caseAAddToRoomShapesRoomType(this);
    }
