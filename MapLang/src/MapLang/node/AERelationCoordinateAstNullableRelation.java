...
public final class AERelationCoordinateAstNullableRelation extends PAstNullableRelation
{
    private PAstCoordinate _astCoordinate_;

    public AERelationCoordinateAstNullableRelation()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AERelationCoordinateAstNullableRelation(
    ...
    {
        ((Analysis) sw).caseAERelationCoordinateAstNullableRelation(this);
    }
