...
public final class AAddTemplateToShapeTypeList extends PTypeList
{
    private PAstMultiId _astMultiId_;

    public AAddTemplateToShapeTypeList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddTemplateToShapeTypeList(
    ...
    {
        ((Analysis) sw).caseAAddTemplateToShapeTypeList(this);
    }
