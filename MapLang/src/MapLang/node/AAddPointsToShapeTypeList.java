...
public final class AAddPointsToShapeTypeList extends PTypeList
{
    private PAstMultiId _astMultiId_;

    public AAddPointsToShapeTypeList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddPointsToShapeTypeList(
    ...
    {
        ((Analysis) sw).caseAAddPointsToShapeTypeList(this);
    }
