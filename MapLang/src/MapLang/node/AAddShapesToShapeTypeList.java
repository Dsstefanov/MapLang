...
public final class AAddShapesToShapeTypeList extends PTypeList
{
    private PAstMultiId _astMultiId_;

    public AAddShapesToShapeTypeList()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAddShapesToShapeTypeList(
    ...
    {
        ((Analysis) sw).caseAAddShapesToShapeTypeList(this);
    }
